...
def getTestSuite():
    ...
    utilsTestSuite.addTest(utilsTestCase("testValidateXmlFileWithSchemaFileBadXml"))
    utilsTestSuite.addTest(utilsTestCase("testValidateXmlFileWithSchemaFileBadXsd"))
    utilsTestSuite.addTest(utilsTestCase("testValidateXmlFileWithSchemaFileNotWellFormedXsd"))
    utilsTestSuite.addTest(utilsTestCase("testValidateXmlFileWithSchemaFileNotWellFormedXml"))
