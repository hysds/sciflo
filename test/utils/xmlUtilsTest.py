...
equalLengthList = [[1,2,3,4,5],['a','b','c','d','e'],['test','test2','test3','test4','test5']]

#equal length list heading
equalLengthHeadingTuple = ('heading1','heading2','heading3','heading4','heading5')
...
unequalLengthHeadingTuple = ('heading1','heading2','heading3','heading4',('heading5','subheading'))
...
class xmlUtilsTestCase(unittest.TestCase):
    ...
    def testGetMinidomXmlDocument(self):
        ...
        doc2 = getMinidomXmlDocument(rootTag,defaultNamespace,xslPath=scifloXslPath)
...
def getTestSuite():
    ...
    xmlUtilsTestSuite.addTest(xmlUtilsTestCase("testXmlTransformXmlStringXslFile"))
    xmlUtilsTestSuite.addTest(xmlUtilsTestCase("testXmlTransformXmlFileXslString"))
    xmlUtilsTestSuite.addTest(xmlUtilsTestCase("testConfigToEndpointConfigXmlTransform"))
