#-----------------------------------------------------------------------------
# Name:        sqlalchemyLibrarianTest.py
# Purpose:     Unit testing for ScifloLibrarian using SqlAlchemyCatalog.
#
...
class sqlalchemyLibrarianTestCase(unittest.TestCase):
    """Test case for ScifloLibrarian using SqlAlchemyCatalog."""
    ...
    def setUp(self):
        ...
        #create the SqlAlchemyCatalog object
        self.catalogobj = SqlAlchemyCatalog(scheme)
...
def getTestSuite():
    ...
    #run tests
    sqlalchemyLibrarianTestSuite = unittest.TestSuite()
    sqlalchemyLibrarianTestSuite.addTest(sqlalchemyLibrarianTestCase("testCrawlAndCatalog"))
    #sqlalchemyLibrarianTestSuite.addTest(sqlalchemyLibrarianTestCase("testCrawlAndCatalogAfterChangedXmlConfig"))

    #return
    return sqlalchemyLibrarianTestSuite
