#-----------------------------------------------------------------------------
# Name:        sqlalchemyCatalogTest.py
# Purpose:     Unit tests for the SqlAlchemyCatalog class.
#
...
class SqlAlchemyCatalogTestCase(unittest.TestCase):
    """Test case for SqlAlchemyCatalog."""

    def setUp(self):
        """Setup."""
        self.obj = SqlAlchemyCatalog(scheme)
...
def getTestSuite():
    ...
    #run tests
    SqlAlchemyCatalogTestSuite = unittest.TestSuite()
    SqlAlchemyCatalogTestSuite.addTest(SqlAlchemyCatalogTestCase("testQueryEmpty"))
    SqlAlchemyCatalogTestSuite.addTest(SqlAlchemyCatalogTestCase("testInsert"))
    SqlAlchemyCatalogTestSuite.addTest(SqlAlchemyCatalogTestCase("testRemove"))
    SqlAlchemyCatalogTestSuite.addTest(SqlAlchemyCatalogTestCase("testInsertList"))
    SqlAlchemyCatalogTestSuite.addTest(SqlAlchemyCatalogTestCase("testGetAllObjectids"))

    #return
    return SqlAlchemyCatalogTestSuite
